...
import com.work.glkt.wechat.service.MessageService;
...
public class MessageServiceImpl implements MessageService {
    ...
    public void pushPayMessage(long id) {
        //微信openid
        String openid = "o5lra6WaNDI7e2KSig0E1zqc8sQU";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("cGMWhnByVUz7XgOsdmuHlmFRWuffVo0TnQmZFg0FZ6A")//模板id
                .url("http://weixin.5gzvip.91tunnel.com/#/pay/"+id)//点击模板消息要访问的网址
                .build();
    ...
    private String search(Map<String, String> param) {
        ...
        if(CollectionUtils.isEmpty(courseList)) {
            ...
            articles.append("<Url><![CDATA[http://onlinetest.5gzvip.91tunnel.com/#/liveInfo/"+course.getId()+"]]></Url>");
            articles.append("</item>");
