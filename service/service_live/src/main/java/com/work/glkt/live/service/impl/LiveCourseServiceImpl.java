...
import com.work.glkt.client.course.CourseFeignClient;
import com.work.glkt.client.user.UserInfoFeignClient;
import com.work.glkt.exception.GlktException;
import com.work.glkt.live.mapper.LiveCourseMapper;
import com.work.glkt.live.mtcloud.CommonResult;
import com.work.glkt.live.mtcloud.MTCloud;
import com.work.glkt.live.service.*;
import com.work.glkt.model.live.*;
import com.work.glkt.model.user.UserInfo;
import com.work.glkt.model.vod.Teacher;
import com.work.glkt.utils.DateUtil;
import com.work.glkt.vo.live.LiveCourseConfigVo;
import com.work.glkt.vo.live.LiveCourseFormVo;
import com.work.glkt.vo.live.LiveCourseGoodsView;
    ...
    //                *  options 		可选参数
        ...
        try {
            ...
            if(Integer.parseInt(commonResult.getCode()) == MTCloud.CODE_SUCCESS) {
                ...
                throw new GlktException(20001,"修改直播课程失败");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
