package com.work.glkt.client.course;
...
public interface CourseFeignClient {
    ...
    List<Course> findByKeyword(@PathVariable(value = "keyword") String keyword);

    @ApiOperation("根据ID查询课程")
    @GetMapping("/api/vod/course/inner/getById/{courseId}")
    Course getById(@PathVariable(value = "courseId") Long courseId);

    @GetMapping("/admin/vod/teacher/inner/getTeacher/{id}")
    public Teacher getTeacherInfo(@PathVariable(value = "id")  Long id);
