package com.work.glkt.client.activity;
...
public interface CouponInfoFeignClient {
	...
	CouponInfo getById(@PathVariable(value = "couponId") Long couponId);

    /**
     * 更新优惠券使用状态
     */
    @GetMapping(value = "/api/activity/couponInfo/inner/updateCouponInfoUseStatus/{couponUseId}/{orderId}")
    Boolean updateCouponInfoUseStatus(@PathVariable(value = "couponUseId") Long couponUseId, @PathVariable("orderId") Long orderId);
