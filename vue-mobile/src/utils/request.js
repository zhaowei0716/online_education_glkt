...
const service = axios.create({
    baseURL: 'http://onlinetest.5gzvip.91tunnel.com', // api 的 base_url
    //http://onlinetest.5gzvip.91tunnel.com
...
service.interceptors.response.use(response => {
        if (response.data.code == 208) {
            ...
            window.location = 'http://onlinetest.5gzvip.91tunnel.com/api/user/wechat/authorize?returnUrl=' + url
        } else {
